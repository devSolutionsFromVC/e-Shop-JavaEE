...
import com.solution.fromVC.entities.OrderDetailPK;
import com.solution.fromVC.store.ejb.OrderDetailBean;
        ...
        if (pagination == null) {
            pagination = new AbstractPaginationHelper(10) {
                ...
                public DataModel createPageDataModel() {
                    ...
                    return new ListDataModel<OrderDetail>(getFacade().findOrderDetailByOrder(orderId));
                }
            };
        }
        return pagination;
