...
import com.solution.fromVC.store.ejb.ProductBean;
    ...
    public void upload() {
        ...
        try {
            ...
            if (!EXTENSIONS_ALLOWED.contains(extension)) {
                logger.severe("Попытка загрузить не изображение. Загрузка прервана.");
            ...
            setStep(3);
            JsfUtil.addSuccessMessage("Изображение товара успешно загружено");
