...
import com.solution.fromVC.store.ejb.AdministratorBean;
import com.solution.fromVC.store.web.util.AbstractPaginationHelper;
import com.solution.fromVC.store.web.util.JsfUtil;
import com.solution.fromVC.store.web.util.MD5Util;
...
public class AdministratorController implements Serializable{
    ...
    private static final Logger logger = Logger.getLogger(AdministratorController.class.getCanonicalName());
    ...
    private void performDestroy() {
        try {
            ...
            if (getFacade().isLastAdministrator()) {
